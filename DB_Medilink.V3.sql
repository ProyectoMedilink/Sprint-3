...
CREATE TABLE HistorialCita (
	...
	CitaId INT NOT NULL,
    CONSTRAINT PK_HistorialC PRIMARY KEY (IdHistorial),
...
('Paciente estable, presión controlada.', '2025-07-22', 'Hipertensión leve', 'Losartán 50mg', 1), 
('Paciente con dolor de rodilla.', '2025-07-22', 'Lesión menisco', 'Ibuprofeno 400mg', 2);
...
-- FACTURAS
INSERT INTO Factura (CedulaId, Total, Tipo, EstadoFactura) VALUES
('234567890', 15000.00, 'membresia', 'pagado'),
('456789012', 40000.00, 'consulta', 'pendiente');
